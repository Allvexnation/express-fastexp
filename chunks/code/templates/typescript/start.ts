export const startPage = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body class="bg-black text-white min-h-screen">
    ...
    <div id="config-message-source" class="hidden">
        <span class="bg-zinc-800 text-gray-300 text-xs px-3 py-1.5 rounded-full">You can configure and remove this in <span class="bg-white text-black px-1.5 py-0.5 rounded font-semibold">index.ts</span></span>
    </div>
    <div id="app"></div>
